...
class ShoesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shoe" do
    assert_difference('Shoe.count') do
      post shoes_url, params: { shoe: { description: @shoe.description, image: @shoe.image, title: @shoe.title } }, as: :json
    end
  ...
  test "should update shoe" do
    patch shoe_url(@shoe), params: { shoe: { description: @shoe.description, image: @shoe.image, title: @shoe.title } }, as: :json
    assert_response 200
  end
